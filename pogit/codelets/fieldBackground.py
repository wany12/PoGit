...
"""
            if (cellIdx.y() == ${iy_antenna}  ){
                ...
                //const float_64 phase = 2.0 * PI * time_SI * SI::SPEED_OF_LIGHT_SI / ${wavelength};
...
distance_3d = "distance2_SI += float_64(cellIdx.z()-${iz_cntr} ) * SI::CELL_DEPTH_SI * float_64(cellIdx.z()-${iz_cntr} ) * SI::CELL_DEPTH_SI;"
